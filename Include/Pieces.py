...
class King():
    def __init__(self, currenPosition):
        self.currenPosition = currenPosition
    def legalKingMove(self, releasedPosition):
        index = None
        targetIndex = None
...
class Rock(Pieces):
    def __init__(self, currenPosition):
        self.currenPosition = currenPosition
    def legalRockMove(self, releasedPosition):
        index = None
        targetIndex = None
        memory = None
        ...
        #print(self.recursionRight(index,targetIndex,memory))
...
class Queen(Rock, Bishop):
    ...
    def legalQueenMove(self, releasedPosition):
        index = None
        targetIndex = None
        memory = None
        ...
        for i, point in enumerate(dragging.coordinates):
            ...
            if point[0] == releasedPosition[0] and point[1] == releasedPosition[1]:
                targetIndex = i
        if (super().legalRockMove(releasedPosition) or super().legalBishopMove(releasedPosition)):
            return True
        else:
            return False
